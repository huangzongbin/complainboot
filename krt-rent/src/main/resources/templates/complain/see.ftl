...
<div class="wrapper">
    ...
    <!-- 隐藏域 --><table class="table table-bordered table-krt">
                           ...
                           <#-- <tr>
                                ...
                                <td class="width-35">
                                    <input type="radio" name="isPhoneReply" id="isPhoneReply" value="1" <#if complain.isPhoneReply?? && complain.isPhoneReply == 1>checked</#if> class="icheck"> 否
                                    <input type="radio" name="isPhoneReply" id="isPhoneReply" value="2" <#if complain.isPhoneReply?? && complain.isPhoneReply == 2>checked</#if> class="icheck"> 是
                                </td>
                            </tr>-->
                            <tr>
                                <td class="active width-15">
                            ...
                            <tr>
                                ...
                                <td class="width-35">
                                    <textarea cols="50" rows="8" name="returnContent"  id="returnContent" class="form-control" required readonly>${complain.returnContent!}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td class="active width-15">
                            ...
                            <tr>
                                ...
                                <td class="width-35">
                                    <input type="text" name="optName" id="optName" value="${currentUser.name!}" class="form-control" readonly>
                                </td>
                            </tr>
                        </table>
                            <!-- 参数 -->
