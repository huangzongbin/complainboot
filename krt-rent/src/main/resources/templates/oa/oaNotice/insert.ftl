    ...
    <!-- 隐藏域 -->
                            <table class="table table-bordered table-krt">
                                <tr>
                                    ...
                                    <td class="width-35"><input type="text" name="title" id="title" class="form-control" rangelength="1,50" required ></td>
                                    <td class="active width-15">
                                        <label class="pull-right">
                                            图片
                                        </label>
                                    ...
                                    <td class="width-35">
                                        <div class="input-group">
                                            <input class="form-control" type="text" id="img" name="img" value="" class="form-control"  readonly="readonly" />
...
<script type="text/javascript">
    ...
    function doSubmit() {
        krt.ajax({
            type: "POST",
            url: "${basePath}/oa/oaNotice/insert",
